"""
ResNet code and pre-trained weigths from https://github.com/huyvnphan/PyTorch_CIFAR10
"""
import os
import numpy as np
import torch
...
from dataset1 import get_cifar10_mu_std_img
from dataset1 import normalize
from path import *
...
def test_pretrained_resnet(x_test, y_test):
    device = "cuda" if torch.cuda.is_available() else "cpu"
    if(device == "cuda"): print("cuda enabled")
    resnet_network = resnet50(pretrained=True, device=device)
    resnet_network.eval()
